        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Button href="/exam" variant="primary" className="bg-white text-forest hover:bg-clay-light">
                Start Practice Exam
              </Button>
              <Button href="/review" variant="secondary" className="border-white/40 text-white hover:bg-white/10">
